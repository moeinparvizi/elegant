...
<br />
<div align="center">
  <a href="https://github.com/moeinparvizi/elegant">
    <img src="assets/media/images/logo-light.svg" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">elegant</h3>

  <p align="center">
    more in formation about this project in readme
    <br />
    ...
    ·
    <a href="https://github.com/moeinparvizi/elegant/issues">Request Feature</a>
  </p>
</div>
...
this project writed with: flex ,grid ,posation ,translate ,transition and any more
	about files:
	in `global.scss` we have all of the colors and functions
	in master have any segment style  
...
| Color             | Hex                                                                |
| ----------------- | ------------------------------------------------------------------ |
| Primary Color |  #000E0E |
| Secondary Color | #2655EB |
| Thirdy Color | #379EFF |
| fourthy Color | #FF4AC2 |
...
1. Clone the repo
   ```sh
   git clone https://github.com/moeinparvizi/elegant.git
   ```
2. open with a browser `index.html` file
...
Project Link: [https://github.com/moeinparvizi/elegant](https://github.com/moeinparvizi/elegant)
